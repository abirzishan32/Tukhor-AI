...
1. **Character Identification**
    ...
    - Q: "অনুপমের ভাষায় সপরুষ কােক বলা হেয়েছ?"
    - Expected: "শুম্ভনাথ"

2. **Destiny Reference**

    - Q: "কাকে অনপেমর ভাগ্য দবতা বেল উল্লেখ করা হয়েছ?"
    - Expected: "মামােক"

3. **Age Information**
    - Q: "বিয়ের সময় কল্যাণীর প্রকত বয়স কত িছল?"
    - Expected: "১৫ বছর"
...
2. **API Testing**
    ...
    POST /api/v1/rag/ask
    {
      "question": "অনপেমর ভাষায় সপরুষ কােক বলা হেয়েছ?",
      "chat_id": null
    }
    ```
